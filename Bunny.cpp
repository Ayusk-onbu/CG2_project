...
void Bunny::Initialize(ModelObject& model, CameraBase& camera) {
	OBJ::Initialize(model, camera);
	worldTransform_.set_.Translation({ 10.0f,0.0f,0.0f });
...
void Bunny::Draw(TheOrderCommand& command, PSO& pso, DirectionLight& light, Texture& tex) {
